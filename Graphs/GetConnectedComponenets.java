...
public class GetConnectedComponenets {
    static class Edge {
        int src;
        int nbr;
        int wt;
     ...
     public static void SingleComp(int src,ArrayList<Edge>[] graph,ArrayList<Integer> scc,boolean[] vis    ){
         vis[src]=true;
